...
@export var endless_program: EndlessTowerProgram
...
#SONIC
var game_address:String = "inZvKYrvf1FFXwuU8ZzbqeMjbBtw8qVUckFuoAg153N"
var leaderboard_address:String = "BQojzq6ek6cjLSf578n16KHk9PL81vSahbv5E3xBxAw4"
var nft_collection:String = "91K83TLvLnCHFVWfYDD7he4JxtnLPA3U8PocWBBpEKpd"
...
func new_floor(name:String ,floor:int) -> void:
	var game_attributes:EndlessUtils.GameAttributes = EndlessUtils.GameAttributes.new()
	game_attributes.name= name
	game_attributes.floor= floor
	
	var auth_keypair = Keypair.new_from_file(game_authority_path)
	var tx_data:TransactionData = await endless_program.init_game(game_attributes, auth_keypair, SolanaService.wallet.get_pubkey())
